    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('areaf1', models.CharField(default='#', max_length=100)),
                ('areaf2', models.CharField(default='#', max_length=100)),
                ('areaf3', models.CharField(default='#', max_length=100)),
                ('areaf4', models.CharField(default='#', max_length=100)),
                ('areaf5', models.CharField(default='#', max_length=100)),
                ('areaf6', models.CharField(default='#', max_length=100)),
                ('areaf7', models.CharField(default='#', max_length=100)),
                ('areaf8', models.CharField(default='#', max_length=100)),
                ('areaf9', models.CharField(default='#', max_length=100)),
                ('areaf10', models.CharField(default='#', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Batch',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch_id', models.IntegerField(default=0)),
                ('status', models.IntegerField(default=0, help_text='0:In Queue,1:Processing,2:Error,3:Done')),
